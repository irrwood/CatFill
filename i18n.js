globalThis.CatFillI18n = (() => {
  const messages = {
    zh: {
      ...
      localFill: "填写当前页面", fillHint: "使用当前档案中的已保存资料", learnHint: "保存你已经填写的内容", aiFill: "用 AI 填写", openOrganizer: "管理我的资料",
    ...
    en: {
      ...
      localFill: "Fill this page", fillHint: "Use details saved in the current profile", learnHint: "Save information you already entered", aiFill: "Fill with AI", openOrganizer: "Manage my details",
