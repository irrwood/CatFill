globalThis.CatFillI18n = (() => {
  const messages = {
    zh: {
      refresh: "刷新", organize: "AI 整理", currentProfile: "当前联系人", tabsLabel: "侧栏功能",
      organizerTab: "字段整理", addTab: "添加资料", settingsTab: "设置", aiSuggestion: "AI 建议",
      suggestionReady: "已生成整理结果", saveSuggestion: "确认保存", discardSuggestion: "忽略",
      field: "字段", addDetails: "添加资料", category: "分类", fieldName: "字段名", value: "值",
      aliasesOptional: "别名（可选）", addField: "添加字段", keyPlaceholder: "如 邮箱、LinkedIn、姓名",
      valuePlaceholder: "要填写的内容", aliasesPlaceholder: "如 email, e-mail",
      uploadDocument: "拖入 PDF、Excel、图片或 TXT，或点击选择", analyze: "AI 分析",
      aiSettings: "AI 设置", save: "保存", provider: "AI 供应商", model: "模型", language: "界面语言",
      ...
      defaultProfile: "默认", noProfile: "还没有联系人资料。请先在 popup 里学习本页内容，或在这里手动添加字段。",
      noEntries: "当前联系人还没有字段。可以学习本页内容，或在上方手动添加字段。", itemCount: "{count} 项",
      enterValue: "填写内容", fileCannotRestore: "浏览器不允许扩展代为重新选择本地文件", alias: "别名",
      saveEdit: "保存", cancel: "取消", edit: "修改", delete: "删除", selectedFile: "已选择文件",
      fieldUpdated: "字段已修改", fieldDeleted: "字段已删除", createProfileFirst: "请先在 popup 新建一个联系人",
      keyAndValueRequired: "字段名和值都需要填写", fieldAdded: "字段已添加", imageFormats: "图片仅支持 JPG、PNG 或 WebP",
      ...
      settingsSaved: "AI 设置已保存", refreshFailed: "刷新失败", noEntriesToOrganize: "当前联系人没有可整理的资料",
      organizeFailed: "AI 整理失败", suggestionSummary: "建议将 {before} 条资料整理为 {after} 条规范字段。",
      profileNew: "新建联系人", profileRename: "重命名", profileDelete: "删除联系人", learnPage: "学习本页已填内容",
      newProfileName: "新联系人名称：", renameProfileName: "新名称：", retainOneProfile: "至少保留一个联系人",
      deleteProfileConfirm: "删除联系人「{name}」？",
      localFill: "一键填写（本地匹配）", aiFill: "AI 智能填写", openOrganizer: "打开字段整理侧栏",
    ...
    en: {
      ...
      organizerTab: "Fields", addTab: "Add details", settingsTab: "Settings", aiSuggestion: "AI suggestion",
      suggestionReady: "Organization ready", saveSuggestion: "Save changes", discardSuggestion: "Discard",
      field: "FIELD", addDetails: "Add details", category: "Category", fieldName: "Field name", value: "Value",
      aliasesOptional: "Aliases (optional)", addField: "Add field", keyPlaceholder: "e.g. Email, LinkedIn, full name",
      valuePlaceholder: "Value to fill", aliasesPlaceholder: "e.g. email, e-mail",
      uploadDocument: "Drop a PDF, spreadsheet, image, or TXT file here, or click to choose", analyze: "Analyze with AI",
      aiSettings: "AI settings", save: "Save", provider: "AI provider", model: "Model", language: "Interface language",
      ...
      defaultProfile: "Default", noProfile: "No profile yet. Learn filled details from the popup, or add a field here.",
      noEntries: "This profile has no fields yet. Learn details from a page, or add one above.", itemCount: "{count} items",
      enterValue: "Value to fill", fileCannotRestore: "Browsers do not let extensions re-select a local file", alias: "Aliases",
      saveEdit: "Save", cancel: "Cancel", edit: "Edit", delete: "Delete", selectedFile: "Selected file",
      fieldUpdated: "Field updated", fieldDeleted: "Field deleted", createProfileFirst: "Create a profile in the popup first",
      keyAndValueRequired: "Field name and value are required", fieldAdded: "Field added", imageFormats: "Images must be JPG, PNG, or WebP",
      ...
      settingsSaved: "AI settings saved", refreshFailed: "Refresh failed", noEntriesToOrganize: "This profile has no details to organize",
      organizeFailed: "AI organization failed", suggestionSummary: "Organize {before} saved details into {after} standardized fields.",
      profileNew: "New profile", profileRename: "Rename", profileDelete: "Delete profile", learnPage: "Learn filled details on this page",
      newProfileName: "New profile name:", renameProfileName: "New name:", retainOneProfile: "Keep at least one profile",
      deleteProfileConfirm: "Delete profile “{name}”?",
      localFill: "Fill fields (local match)", aiFill: "Fill with AI", openOrganizer: "Open field organizer",
