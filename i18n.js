globalThis.CatFillI18n = (() => {
  const messages = {
    zh: {
      ...
      applyingTo: "正在申请", viewOnLinkedIn: "在 LinkedIn 查找公司", viewOnGlassdoor: "搜索并确认 Glassdoor 公司页面",
    ...
    en: {
      ...
      applyingTo: "Applying to", viewOnLinkedIn: "Find this company on LinkedIn", viewOnGlassdoor: "Search for and confirm the Glassdoor company page",
