globalThis.CatFillI18n = (() => {
  const messages = {
    zh: {
      ...
      field: "字段", addDetails: "添加资料", addDetailsHint: "单独录入一项资料，或从文件中批量提取。", addModeLabel: "添加资料方式",
      ...
      filling: "正在填写表单…", fillResult: "已填充 {filled}/{total} 个字段", aiAnalyzing: "正在理解表单…",
    ...
    en: {
      ...
      field: "FIELD", addDetails: "Add details", addDetailsHint: "Add one saved detail, or extract several from a file.", addModeLabel: "Add details method",
      ...
      filling: "Filling this form…", fillResult: "Filled {filled}/{total} fields", aiAnalyzing: "Understanding this form…",
